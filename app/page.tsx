        ...
        <main className="text-white overflow-x-hidden">
            ...
            <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 relative overflow-hidden">
                ...
                <div className="flex gap-16 mt-20 text-center">
                    ...
                    <div className="group">
                        <h3 className="text-3xl font-semibold group-hover:scale-110 transition">500+</h3>
                        <p className="text-gray-500 text-sm">Premium Designs</p>
                    </div>

                    <div className="group">
                        <h3 className="text-3xl font-semibold group-hover:scale-110 transition">12K+</h3>
                        <p className="text-gray-500 text-sm">Happy Customers</p>
                    </div>

                    <div className="group">
                        <h3 className="text-3xl font-semibold group-hover:scale-110 transition">4.9★</h3>
                ...
                <div className="flex justify-center">
                    <div className="flex gap-10 overflow-x-auto px-10 scrollbar-hide">
                        ...
                        {[
                            ...
                            <div key={i} className="min-w-[260px] h-[380px] rounded-t-[140px] rounded-b-[30px] overflow-hidden relative group cursor-pointer">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-5 backdrop-blur-md bg-white/5 opacity-0 group-hover:opacity-100 transition duration-500">
                                    <h3 className="text-lg tracking-wide">Urban Fit {i + 1}</h3>
                                    <p className="text-gray-300 text-sm mt-1">Premium streetwear collection</p>
                                </div>
            ...
            {/* ===== FASHION VISUAL ===== */}
            <section className="min-h-screen px-16 py-28">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="relative group flex justify-center">
                        <img
                            ...
                            className="w-[400px] h-[600px] object-cover rounded-[35px] shadow-xl group-hover:scale-105 transition duration-700"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-8 leading-relaxed">
                            Urban Thread creates fashion that reflects individuality and modern confidence.
                        </p>
                    </div>
            ...
            <section 
                id="contact"
                className="min-h-screen flex flex-col justify-center items-center text-center px-6 scroll-mt-28"
            >
                ...
                <div className="mt-10 space-y-3 text-gray-300">
                    <p>Email: <span className="text-gray-400 ml-2">support@urbanthread.com</span></p>
                    <p>Phone: <span className="text-gray-400 ml-2">+91 98765 43210</span></p>
                    <p>Location: <span className="text-gray-400 ml-2">New Delhi, India</span></p>
                </div>
